			...
			<body>
				<span style="font-family:Century Gothic; font-size:larger;">
					<xsl:for-each select="$XML">
						<br/>
						<img width="132" height="72" alt="Reliant Energy" src="http://www.reliant.com//en_US/Images/Site_Component_Images/Header/reliant_logo_trans.png"/>
						<br/><br/>
								...
								<tr>
									<td>
										<span style="font-family:Century Gothic; font-size:larger; font-weight:bold; ">
											<p><xsl:text>If you have any questions about your electricity usage below, please call us at 1-866-222-7100</xsl:text></p>
											<p><xsl:text>Also, the Reliant Home Energy Checkup is a great way to find out just how energy efficient your home actually is, and to obtain, free information that could improve your home's energy efficiency, and possibly save you money.</xsl:text></p>
											<p><xsl:text>Call 1-888-339-7378 to schedule an appointment.</xsl:text></p>
										</span>
									</td>
								</tr>
				...
				<xsl:for-each select="atom:entry">
					<xsl:for-each select="atom:content">
						<xsl:for-each select="espi:ElectricPowerUsageSummary">
							...
							<br/>
							<br/>
								<xsl:text>Current usage data as of: </xsl:text>
							...
							<br/>
							<!-- 
							//Removed as part of Development as we are not showing user any Billing Information
							<xsl:for-each select="espi:billingPeriod">
								<br/>
